...
public abstract class Constant implements Cast {
    ...
    public static final int FIELDREF = 9;                 // 45.3 1.0.2
    public static final int METHODREF = 10;               // 45.3 1.0.2
    public static final int INTERFACEMETHODREF = 11;      // 45.3 1.0.2
